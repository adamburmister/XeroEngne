...
#   plan.name = 'Starter plan subscription'
#   plan.amount = 500 # amount in cents
#   plan.interval = 'month'
# end
#
# Stripe.plan :standard do |plan|
#   plan.name = 'Standard plan subscription'
#   plan.amount = 2000 # amount in cents
#   plan.interval = 'month'
# end
#
# Stripe.plan :large do |plan|
#   plan.name = 'Large plan subscription'
#   plan.amount = 50000 # amount in cents
#   plan.interval = 'month'
# end
